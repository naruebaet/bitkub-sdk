...
// Method : GET
func (bksdk *Bitkubsdk) GetSymbols() (response.MarketSymbols, error) {
	// init response body
...
// Method : GET
func (bksdk *Bitkubsdk) GetTicker(sym string) (response.MarketTicker, error) {
	// init response body
...
// Method : GET
func (bksdk *Bitkubsdk) GetTrade(sym string, limit int) (response.MarketTrades, error) {
	// init response body
...
// Method : GET
func (bksdk *Bitkubsdk) GetBids(sym string, limit int) (response.MarketBids, error) {
	// init response body
...
// Method : GET
func (bksdk *Bitkubsdk) GetAsks(sym string, limit int) (response.MarketAsks, error) {
	// init response body
...
// Method : GET
func (bksdk *Bitkubsdk) GetBooks(sym string, limit int) (response.MarketBooks, error) {
	// init response body
...
// Endpoint : /api/market/books
// Method : GET
func (bksdk *Bitkubsdk) GetDepth(sym string, limit int) (response.MarketDepth, error) {
	// init response body
...
*/
func (bksdk *Bitkubsdk) GetHistory(symbol string, resolution string, from int, to int) (response.TradingviewHistory, error) {
	// init response body
